...
# Add the bots directory to the load path so we can require files relatively
$LOAD_PATH.unshift File.expand_path('..', __dir__)

# Load the main options_trader gem for dependencies
...
RSpec.configure do |config|
  ...
  config.example_status_persistence_file_path = 'bots/.rspec_status'

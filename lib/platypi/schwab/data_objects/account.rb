    ...
    module DataObjects
      class InitialBalances
        attr_reader :accrued_interest, :cash_balance, :cash_receipts, :long_option_market_value,
                    :liquidation_value, :money_market_fund, :available_funds_non_marginable_trade,
                    :bond_value, :buying_power, :cash_available_for_trading, :day_trading_buying_power,
                    :day_trading_buying_power_call, :day_trading_equity_call, :equity, :equity_percentage,

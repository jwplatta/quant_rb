    ...
    module DataObjects
      class QuoteFactory
        def self.build(quote_data)
          ...
          when 'OPTION'
            OptionsTrader::Schwab::DataObjects::OptionQuote.new(data)
          when 'INDEX'
            OptionsTrader::Schwab::DataObjects::IndexQuote.new(data)
          when 'EQUITY'
            OptionsTrader::Schwab::DataObjects::EquityQuote.new(data)
          else
